...
(function() {
  var TitleManager, UnreadCountManager;

  TitleManager = (function() {
    function TitleManager(title) {
      this.title = title != null ? title : "MockingJay";
    }
  ...
  UnreadCountManager = (function() {
    function UnreadCountManager(socket, titleManager) {
      this.socket = socket;
    ...
    UnreadCountManager.prototype._resetUnreadCount = function() {
      this.unreadCount = 0;
      return this._updateTitle();
    };

    UnreadCountManager.prototype._updateTitle = function() {
      var title;
      title = this.titleManager.title;
      if (this.unreadCount > 0) {
        title = "(" + this.unreadCount + ") " + this.titleManager.title;
      }
